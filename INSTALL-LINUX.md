...
```
https://<account>.lacework.net/mgr/v1/download/<token>/install.sh
```
...
1. Download the installation script using `wget`:
   ...
   **Example:**
   ```bash
   wget https://<account>.lacework.net/mgr/v1/download/<token>/install.sh
   ```
...
- [Install Linux Agent Documentation](https://docs.fortinet.com/document/forticnapp/latest/administration-guide/171566/agents)
